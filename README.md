# Project Setup Guide
Here is a guide for the step-by-step instructions to set up the project environment, including the installation of FFmpeg and PortAudio across MacOS, Linux, and Windows. Also setting up a python virtual environment using Pipenv, pip or conda.
